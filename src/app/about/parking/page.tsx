  ...
  return (
    <>
      <PageHero
        eyebrow="Parking"
        title="주차안내"
        description="조문객과 유가족이 편리하게 이용하실 수 있도록 주차 정보를 안내해드립니다."
      ...
      <section className="subpage-body mx-auto max-w-7xl px-6 py-16">
        ...
        <Prose>
          <h3>주차장 이용 안내</h3>
          <ul>
            <li>장례식장 정문 진입 후 지상 주차장 안내 표지에 따라 주차 구역을 이용해주십시오.</li>
            <li>장례 기간 중 조문객 차량은 무료로 이용 가능합니다.</li>
            <li>장애인 전용 주차구역이 별도로 마련되어 있습니다.</li>
            <li>전기차 충전소 2기를 운영합니다.</li>
          </ul>
          <h3>대형 차량 안내</h3>
          <ul>
            <li>버스·승합차의 경우 정문 좌측 지상 임시주차 구역을 이용해주시기 바랍니다.</li>
